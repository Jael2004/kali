...
export function LetterSection() {
  const paragraphs = [
    ...
    "Je n'ai sans doute pas donné les meilleurs conseils, ou fait ni dit ce qui fallait pour t'aider. Ça me fait mal de constater qu'avec un peu de recul je ne t'ai rien apporté de beau, ni d'important...",
...
‎
    ...
    "Je me mets à ton service de gré ou de force. On dira peut-être que c'est à ton gars de se montrer romantique avec toi mais moi je me plie à cette tâche, parce que actuellement je crois qu'aucun homme ne te mérite, et un homme te méritera lorsqu'il sera à la hauteur de nos attentes à nous moi.",
...
‎
    ...
    "Avec toute mon amour, ton emmerdeuse Jaël 💜"
  ];
